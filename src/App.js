  ...
  render() {
    return (
      <div className="App">
        ...
        <button className="Button" onClick={this.onToggle}>Toggle</button>
        <br />
        {/*this.state.showBlock ? <div style={{ backgroundColor: 'red', width: '100px', height: '100px', margin: 'auto' }} /> : null*/}
        <Transition 
